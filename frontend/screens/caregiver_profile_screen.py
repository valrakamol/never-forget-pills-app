...
class CaregiverProfileScreen(Screen):
    # --- *** จุดที่แก้ไขทั้งหมด *** ---
    # เปลี่ยนจาก StringProperty มาเป็น ObjectProperty เพื่อเชื่อมกับ Label โดยตรง
    ...
    def load_profile_data(self):
        """
        ดึงข้อมูลโปรไฟล์จากที่เก็บไว้ในเครื่อง (JsonStore) ก่อน
        ถ้าไม่มี ค่อยไปดึงจาก API
        """
        ...
        if auth_info and self.full_name_label and self.username_label:
            ...
            # ถ้าหาข้อมูลในเครื่องไม่เจอ ให้ไปดึงจาก API
