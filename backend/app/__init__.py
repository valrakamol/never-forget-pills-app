...
# 1. Import instances ทั้งหมดจาก extensions.py
from .extensions import db, migrate, jwt, admin, cors
...
def register_admin_views(app):
    ...
    with app.app_context():
        ...
        from .models import (
            ...
            Notification, SystemSetting, MasterMedicine
        )
        ...
        from .admin_views import (
            ...
            MasterMedicineAdminView, HealthRecordAdminView, AppointmentAdminView
        )
        ...
        admin.add_view(MasterMedicineAdminView(MasterMedicine, db.session, name="Master Medicines", endpoint="admin_mastermed", category="Management"))
